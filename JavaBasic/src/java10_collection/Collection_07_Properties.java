...
//		prop.setProperty("A", 100);
		...
		try {
			writer = new FileWriter("D:\\D\\Desktop\\JavaBasic\\src\\java10_collection\\user.properties");
		...
		try {
			reader = new FileReader("D:\\D\\Desktop\\JavaBasic\\src\\java10_collection\\user.properties");
