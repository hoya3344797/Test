...
//		File file1 = new File("D:\\filetest\\test.txt");
		...
		System.out.println("length :" + file1.length() + " Byte"); // 파일의 크키
		...
		System.out.println("length :" + file2.length() + " Byte"); // 파일의 크키
...
//		File file3 = new File("D:/filetest");
		...
		System.out.println("length :" + file3.length() + " Byte"); // 파일의 크키
